...
{
    public unsafe class OpenGlBackend : IBackend
    {
        ...
        public void CreateDisplay(Device device)
        {
            ...
            int[] context_attribs = {
                Egl.CONTEXT_CLIENT_VERSION, 4,
                Egl.CONTEXT_MINOR_VERSION, 5,
                Egl.CONTEXT_OPENGL_PROFILE_MASK, (int)Egl.CONTEXT_OPENGL_CORE_PROFILE_BIT,
                Egl.NONE,
            };
        ...
        public void PrepareRender(Window window)
        {
